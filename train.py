...
if __name__ == "__main__":
    # Argument parser
    parser = argparse.ArgumentParser(description="Train an XGBoost model on stacked data.")
    parser.add_argument('--train-file', required=True, type=str, help="Path to train.txt specifying the parquet files for training.")
    parser.add_argument('--model-output', required=True, type=str, help="Path to save the trained model.")
